            ...
            <div className="hideScrollBar overflow-scroll overflow-x-hidden h-[80vh]">
                ...
                <div className="w-full transform -translate-y-20 ml-4 h-[6rem]">
                  <div className="relative">
                    <Avatar
                      ...
                      src={ selectedImage || auth.user?.image || "https://images.pexels.com/photos/18999918/pexels-photo-18999918.jpeg?cs=srgb&dl=pexels-andrej375-18999918.jpg&fm=jpg"}
                    />
              ...
              <div className="space-y-3">
                ...
                <div className="my-3">
                  ...
                  <p className="text-2xl">June 7, 1999</p>
                </div>
